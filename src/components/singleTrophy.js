...
const SingleTrophy = ({ icon, cupNumber, cup, years }) => {
  return (
    <div className="p-5 hover:shadow-md duration-300 h-full border rounded-lg flex flex-col justify-start w-full items-center flex-nowrap hvr-icon-grow">
      <div className="text-8xl text-black text-center hvr-icon">{icon}</div>{" "}
      <h4 className="text-2xl text-black py-5 text-center">
